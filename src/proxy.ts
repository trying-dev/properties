...
const roleRouteAccess = {
  admin: {
    ...
    MANAGER: ['/dashboard/admin', '/dashboard/admin/manager', '/dashboard/admin/users', '/dashboard/admin/payments'],
    STANDARD: ['/dashboard/admin', '/dashboard/admin/properties', '/dashboard/admin/payments'],
    LIMITED: ['/dashboard'],
  },
