...
export async function getAvailableUnitsAction(filters?: {
  propertyId?: string;
  minRent?: number;
  maxRent?: number;
  bedrooms?: number;
...
export async function getUnitByIdAction(unitId: string) {
  try {
...
export async function getPropertiesWithAvailableUnitsAction() {
  try {
...
export async function getUnitsByPropertyAction(propertyId: string) {
  try {
