...
async function main() {
  ...
  console.log(
    `   - ${tenant1.user.name} ${tenant1.user.lastName} (${tenant1.references.length} referencias)`,
  );
  console.log(
    `   - ${tenant2.user.name} ${tenant2.user.lastName} (${tenant2.references.length} referencias)`,
  );
  console.log(
    `   - ${tenant3.user.name} ${tenant3.user.lastName} (${tenant3.references.length} referencias)`,
  );
  console.log(
    `   - ${tenant4.user.name} ${tenant4.user.lastName} (${tenant4.references.length} referencias)`,
  );
